...
<h1 style="    margin-left: 589px;">Add Banner Page</h1>

<form action="{{url('/add-banner/')}}" method="post"style="margin-top: 69px;
    margin-left: 122px;"enctype="multipart/form-data">{{csrf_field()}}


  <div class="form-group">
    <label for="banner_image"class="form-label">banner Image</label>
    <input name="banner_image" class="form-control" id="banner_image" placeholder="banner_image" type="file">
  </div>
    <div class="form-group">
