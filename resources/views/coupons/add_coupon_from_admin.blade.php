...
<h1 style="margin-left: 582px;"> ADD  COUPON User</h1>

<div class="from">

  <form action="{{url('/admin/add-coupon')}}" method="post" enctype="multipart/form-data" style="    margin-top: 25px;
    margin-left: 122px;">
  {{csrf_field()}}
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <option value="amount_type" disabled>Amount Type</option>
